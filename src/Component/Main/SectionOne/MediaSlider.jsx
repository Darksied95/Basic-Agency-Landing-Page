...
const MediaSlider = () => {
  return (
    <div className="flex mt-8 overflow-x-auto mb-20 scrollbar-none z-50 pl-5 xs:pl-9 md:pl-14 xl:px-14">
      <div className="min-w-[70vw] md:min-w-[40vw] xl:min-w-[20vw]  mr-5">
      ...
      <div className="min-w-[70vw] md:min-w-[40vw] xl:min-w-[20vw] ">
